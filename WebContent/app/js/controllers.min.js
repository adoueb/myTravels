...
'use strict';
/* Controllers */
angular.module('travelApp.controllers', []).controller('TravelListCtrl', [
  '$scope',
  '$log',
  '$http',
  'TravelRest',
  function ($scope, $log, $http, TravelRest) {
    ...
    */
    ...
    $scope.sendEmail = function () {
      var link = 'mailto:' + $scope.address + '&subject=' + escape($scope.subject) + '&body=' + escape($scope.body);
